...
- (instancetype)init {
    // use initWithName or initWithPath to create CCCache instance.
...
- (instancetype)initWithPath:(NSString *)path {
    ...
    CCDiskCache * diskCache = [[CCDiskCache alloc] initWithPath:path];
    if (!diskCache) return nil;
    NSString * name = [path lastPathComponent];
    CCMemoryCache * memoryCache = [CCMemoryCache new];
